...
class _ScrollableArea(ttk.Frame):
    """Área rolável verticalmente (Canvas + Frame interno) — as 7 seções de
    tabela juntas costumam passar da altura da tela. Os widgets de conteúdo
    são criados com `interior` como pai de verdade (evita o problema de
    misturar pack/grid com `in_=` num container diferente do pai real)."""
...
class ExcluirContasPanel(ttk.Frame):
    ...
    def _build(self):
        ...
        self.area = _ScrollableArea(self)
